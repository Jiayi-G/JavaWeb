...
(function (factory) {
    ...
    function buildBootstrapModalHTML() {
        ...
        var modalHtml = '<div class="modal fade" id="idAMapPositionPickerModal">'
            ...
            + '<div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><h4 class="modal-title">请选择学历</h4><small id="idAMapPositionPickerAlert" style="color: red">必须选择一个位置</small></div>'
