<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:43px;backgroundColor:rgba(32, 137, 202, 1);borderRadius:0 160px 0 0 ;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:5px 3px 5px 5px;borderStyle:solid;borderColor:rgba(32, 137, 202, 1);">
