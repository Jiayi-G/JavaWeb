<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户名" prop="xuehao">
          <el-input v-model="ruleForm.xuehao" 
              placeholder="用户名" clearable  :readonly="ro.xuehao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户名" prop="xuehao">
              <el-input v-model="ruleForm.xuehao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学历" prop="banji">
          <el-input v-model="ruleForm.banji" 
              placeholder="学历" clearable  :readonly="ro.banji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学历" prop="banji">
              <el-input v-model="ruleForm.banji" 
  ...
  data() {
    ...
    var validateUrl = (rule, value, callback) => {
      if(!value){
        ...
        callback(new Error("请输入正确的URL学历"));
      } else {
        callback();
      }
    };
    ...
    return {
	  addEditForm: {"btnSaveFontColor":"#fff","selectFontSize":"14px","btnCancelBorderColor":"rgba(32, 137, 202, 1)","inputBorderRadius":"4px","inputFontSize":"14px","textareaBgColor":"#fff","btnSaveFontSize":"14px","textareaBorderRadius":"4px","uploadBgColor":"#fff","textareaBorderStyle":"solid","btnCancelWidth":"88px","textareaHeight":"120px","dateBgColor":"#fff","btnSaveBorderRadius":"4px","uploadLableFontSize":"14px","textareaBorderWidth":"5px 2px","inputLableColor":"#606266","addEditBoxColor":"#fff","dateIconFontSize":"14px","btnSaveBgColor":"rgba(32, 137, 202, 1)","uploadIconFontColor":"rgba(32, 137, 202, 1)","textareaBorderColor":"rgba(32, 137, 202, 1)","btnCancelBgColor":"rgba(255, 255, 255, 1)","btnSaveBorderStyle":"solid","dateBorderWidth":"5px 2px","dateLableFontSize":"14px","dateBorderRadius":"4px","btnCancelBorderStyle":"solid","selectLableFontSize":"14px","selectBorderStyle":"solid","selectIconFontColor":"rgba(32, 137, 202, 1)","btnCancelHeight":"44px","inputHeight":"40px","btnCancelFontColor":"rgba(32, 137, 202, 1)","dateBorderColor":"rgba(32, 137, 202, 1)","dateIconFontColor":"rgba(32, 137, 202, 1)","uploadBorderStyle":"solid","dateBorderStyle":"solid","dateLableColor":"#606266","dateFontSize":"14px","inputBorderWidth":"5px 2px","uploadIconFontSize":"28px","selectHeight":"40px","inputFontColor":"#606266","uploadHeight":"148px","textareaLableColor":"#606266","textareaLableFontSize":"14px","btnCancelFontSize":"14px","inputBorderStyle":"solid","btnCancelBorderRadius":"4px","inputBgColor":"#fff","inputLableFontSize":"14px","uploadLableColor":"#606266","uploadBorderRadius":"4px","btnSaveHeight":"44px","selectBgColor":"#fff","btnSaveWidth":"88px","selectIconFontSize":"14px","dateHeight":"40px","selectBorderColor":"rgba(32, 137, 202, 1)","inputBorderColor":"rgba(32, 137, 202, 1)","uploadBorderColor":"rgba(32, 137, 202, 1)","textareaFontColor":"#606266","selectBorderWidth":"5px 2px","dateFontColor":"#606266","btnCancelBorderWidth":"1px","uploadBorderWidth":"5px 2px","textareaFontSize":"14px","selectBorderRadius":"4px","selectFontColor":"#606266","btnSaveBorderColor":"rgba(32, 137, 202, 1)","btnSaveBorderWidth":"1px"},
      id: '',
      type: '',
      ro:{
	xuehao : false,
