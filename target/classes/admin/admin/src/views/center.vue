<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="用户名" prop="xuehao">
          <el-input v-model="ruleForm.xuehao" readonly              placeholder="用户名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="学历" prop="banji">
          <el-input v-model="ruleForm.banji"               placeholder="学历" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
