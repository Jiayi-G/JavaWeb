<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">志愿者服务管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			   <div class="label">用户名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xuehao" class="input" type="text" placeholder="用户名">
			   </div>
			 </div> -->
			<el-form-item label="用户名" class="input" v-if="tableName=='zhiyuanzhe'">
			  <el-input v-model="ruleForm.xuehao" autocomplete="off" placeholder="用户名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			...
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.banji" class="input" type="text" placeholder="学历">
			   </div>
			 </div> -->
			<el-form-item label="学历" class="input" v-if="tableName=='zhiyuanzhe'">
			  <el-input v-model="ruleForm.banji" autocomplete="off" placeholder="学历"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
