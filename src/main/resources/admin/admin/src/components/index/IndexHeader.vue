<template>
	<!-- <el-header>
		<el-menu background-color="#1c8ed5" text-color="#FFFFFF" active-text-color="#FFFFFF" mode="horizontal">
	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#fff","headFontSize":"20px","headUserInfoFontColor":"rgba(32, 137, 202, 1)","headBoxShadow":"0 1px 6px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(193, 193, 193, 0.55)","headFontColor":"rgba(32, 137, 202, 1)","headTitleImg":false,"headHeight":"80px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"#fff url(\"https://) repeat top","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(32, 137, 202, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
