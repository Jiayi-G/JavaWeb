tinymce.PluginManager.add('indent2em', function(editor, url) {
    ...
    editor.ui.registry.addButton('indent2em', {
        text: '<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path d="M170.666667 563.2v-102.4H887.466667v102.4zM170.666667 836.266667v-102.4H887.466667v102.4zM512 290.12D93CA33v-102.4H887.466667v102.4zM238.92D93CA33 341.2D93CA2D93CAV136.52D93CA33l204.8 102.4z" fill="#2c2c2c" p-id="5210"></path></svg>',
        tooltip: pluginName,
        onAction: function () {
            doAct();
        }
